...
```clj
 ...
 const<'c> : (const (nil) :FooBar)
       ...
       int : (lvasgn :stmt2 (int 1))
        'd : (def :sum0 (args) (false))
        'e : (def :sum1 (args (arg :thing)) (int 45))
        'f : (def :sum2 (args (arg :thing1) (arg :thing2)) (nil))
      bool : (false)
 array<'g> : (lvasgn :y (array (int 1) (int 2) (int 3)))
        'h : (send (lvar :y) :first)
lambda<'i> : (lvasgn :func1 (block (lambda) (args) (int 45)))
lambda<'j> : (lvasgn :func2 (block (lambda) (args (arg :local)) (nil)))
lambda<'k> : (lvasgn :func3 (block (lambda) (args (arg :local) (arg :_x)) (send (lvar :local) :first)))
        'l : (send (lvar :func3) :call)
       int : (lvasgn :b (int 3))
        'm : (lvasgn :a (lvar :b))
```
